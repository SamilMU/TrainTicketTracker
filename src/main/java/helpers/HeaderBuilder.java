...
public class HeaderBuilder {
    ...
    private static Header returnContentLengthHeader(int contentLength) {
        return  new Header("~Content-Length", "251");
    }
}
